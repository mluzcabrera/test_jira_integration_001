...
Disclaimer
⚠️ WARNING: This application contains intentionally vulnerable code and should never be run in a production environment or used for any real-world purposes. Running this code can potentially harm your system or expose it to security risks. ⚠️
...
To demonstrate unsafe programming practices and common security vulnerabilities in go applications.
To serve as a resource for developers to learn about secure coding practices and how to avoid common pitfalls.
To provide a test suite for evaluating the effectiveness of static analysis tools in detecting vulnerabilities.
Vulnerabilities
...
Each vulnerability is accompanied by comments explaining the issue, the associated Common Weakness Enumeration (CWE), and best practices to mitigate the vulnerability.
